...
BEGIN
  FOREACH dup_id IN ARRAY duplicate_ids LOOP
    -- Tables with client_id FK to clients
    ...
    UPDATE public.proposal_contacts SET client_id = primary_id WHERE client_id = dup_id;
    ...
    UPDATE public.client_payment_analytics SET client_id = primary_id WHERE client_id = dup_id;
    UPDATE public.client_retainers SET client_id = primary_id WHERE client_id = dup_id;
    UPDATE public.claimflow_referrals SET client_id = primary_id WHERE client_id = dup_id;
    UPDATE public.company_reviews SET client_id = primary_id WHERE client_id = dup_id;
    UPDATE public.invoice_disputes SET client_id = primary_id WHERE client_id = dup_id;
    UPDATE public.payment_plans SET client_id = primary_id WHERE client_id = dup_id;
    UPDATE public.payment_predictions SET client_id = primary_id WHERE client_id = dup_id;
    UPDATE public.payment_promises SET client_id = primary_id WHERE client_id = dup_id;
    UPDATE public.rfp_partner_outreach SET partner_client_id = primary_id WHERE partner_client_id = dup_id;
