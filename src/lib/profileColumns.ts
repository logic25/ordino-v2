...
export const PROFILE_COLUMNS_NO_GOALS =
  "id,user_id,company_id,role,portal_role,first_name,last_name,display_name,phone,avatar_url,preferences,is_active,created_at,updated_at,phone_extension,signature_data,about,carrier,job_title,notification_preferences,onboarding_completed,ooo_from,ooo_to,ooo_covering_pm_id,ooo_note,is_comp_admin";
