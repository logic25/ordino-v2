...
export interface MockService {
  ...
  totalAmount: number;
  billedAmount: number;
  costAmount: number; // internal cost (hours * rate)
  assignedTo: string;
...
const MOCK_SERVICES_A: MockService[] = [
  ...
  { id: "s4", name: "Alteration Type 2 D14 Approval", status: "in_progress", application: { jobNumber: "520112847", type: "ALT2" }, subServices: ["MH", "PL", "SP"], totalAmount: 4500, billedAmount: 0, costAmount: 393.75, assignedTo: "Natalia S.", estimatedBillDate: "02/27/2026", billedAt: null, scopeOfWork: "File the required applications and plans with the DOB.\nAttend the required plan examinations to review & resolve issued objections as required to obtain approval.", notes: "Waiting on structural calcs from architect for beam support.", needsDobFiling: false, tasks: [{ id: "t4", text: "Request structural calcs from Antonio", done: true }, { id: "t5", text: "Respond to DOB objection", done: false, assignedTo: "Natalia S.", dueDate: "02/18/2026" }] },
  { id: "s5", name: "Work Permit", status: "not_started", application: null, subServices: ["MH"], totalAmount: 250, billedAmount: 0, costAmount: 0, assignedTo: "Natalia S.", estimatedBillDate: "02/27/2026", billedAt: null, scopeOfWork: "File and obtain mechanical work permit.", notes: "", needsDobFiling: true, tasks: [] },
  { id: "s6", name: "Letter of Completion", status: "not_started", application: null, subServices: [], totalAmount: 750, billedAmount: 0, costAmount: 0, assignedTo: "Natalia S.", estimatedBillDate: "06/30/2026", billedAt: null, scopeOfWork: "Obtain Letter of Completion for mechanical systems.", notes: "", needsDobFiling: false, tasks: [] },
];

const MOCK_SERVICES_B: MockService[] = [
  { id: "s7", name: "Zoning Analysis", status: "billed", application: { jobNumber: "520112847", type: "ALT2" }, subServices: [], totalAmount: 1200, billedAmount: 1200, costAmount: 525, assignedTo: "Sheri L.", estimatedBillDate: "01/15/2026", billedAt: "01/18/2026", scopeOfWork: "Complete zoning analysis and confirm project compliance.", notes: "Completed ahead of schedule.", needsDobFiling: false, tasks: [] },
  { id: "s8", name: "DOB Filing", status: "in_progress", application: { jobNumber: "520112847", type: "ALT2" }, subServices: ["GC"], totalAmount: 650, billedAmount: 0, costAmount: 262.50, assignedTo: "Natalia S.", estimatedBillDate: "02/28/2026", billedAt: null, scopeOfWork: "Prepare and submit DOB application.", notes: "Square footage discrepancy — need architect confirmation.", needsDobFiling: false, tasks: [{ id: "t6", text: "Confirm sq footage with architect", done: false, assignedTo: "Natalia S.", dueDate: "02/20/2026" }] },
  { id: "s9", name: "Expediting", status: "not_started", application: null, subServices: [], totalAmount: 500, billedAmount: 0, costAmount: 0, assignedTo: "Sheri L.", estimatedBillDate: "03/15/2026", billedAt: null, scopeOfWork: "Expedite DOB review process.", notes: "", needsDobFiling: true, tasks: [] },
  { id: "s10", name: "Inspections Coordination", status: "not_started", application: null, subServices: ["GC", "MH"], totalAmount: 400, billedAmount: 0, costAmount: 0, assignedTo: "Natalia S.", estimatedBillDate: "04/30/2026", billedAt: null, scopeOfWork: "Schedule and coordinate all required DOB inspections.", notes: "", needsDobFiling: false, tasks: [] },
];
...
const MOCK_DOCUMENTS_A: MockDocument[] = [
  { id: "d1", name: "Architectural Plans v1.pdf", type: "PDF", uploadedBy: "Antonio Rossi", uploadedDate: "02/07/2026", size: "12.4 MB" },
  { id: "d2", name: "DOB Objection Notice.pdf", type: "PDF", uploadedBy: "System", uploadedDate: "02/12/2026", size: "245 KB" },
  { id: "d3", name: "Fire Alarm Layout.dwg", type: "DWG", uploadedBy: "Antonio Rossi", uploadedDate: "02/07/2026", size: "8.1 MB" },
];

const MOCK_DOCUMENTS_B: MockDocument[] = [
  { id: "d4", name: "Zoning Analysis Report.pdf", type: "PDF", uploadedBy: "Sheri Lopez", uploadedDate: "01/18/2026", size: "1.2 MB" },
  { id: "d5", name: "ALT2 Application.pdf", type: "PDF", uploadedBy: "Natalia Smith", uploadedDate: "01/20/2026", size: "890 KB" },
];
...
const MOCK_TIME_B: MockTimeEntry[] = [
  { id: "te4", date: "01/18/2026", user: "Sheri L.", service: "Zoning Analysis", hours: 3.0, description: "Completed full zoning analysis", billable: true },
  { id: "te5", date: "01/20/2026", user: "Natalia S.", service: "DOB Filing", hours: 1.5, description: "Prepared and submitted ALT2 application", billable: true },
];
