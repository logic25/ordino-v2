...
const MOCK_SERVICES_E: MockService[] = [
  ...
  { id: "se2", name: "Work Permit", status: "not_started", application: null, subServices: ["GC"], totalAmount: 500, billedAmount: 0, costAmount: 0, assignedTo: "Don Speaker", estimatedBillDate: "04/01/2026", billedAt: null, scopeOfWork: "File and obtain general construction work permit after ALT2 approval.", notes: "", needsDobFiling: false, tasks: [], requirements: [{ id: "re5", label: "ALT2 application approved", met: false, fromWhom: "DOB" }], allottedHours: 2, parentServiceId: "se1" },
