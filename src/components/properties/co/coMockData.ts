...
export const STATUS_COLORS: Record<string, string> = {
  ...
  "Permitted": "bg-blue-500/10 text-blue-700 border-blue-500/20",
  "Partial Permit": "bg-blue-500/10 text-blue-700 border-blue-500/20",
  ...
  "Plan Exam Partial Approval": "bg-cyan-500/10 text-cyan-700 border-cyan-500/20",
  "In Process": "bg-yellow-500/10 text-yellow-700 border-yellow-500/20",
  "Plan Exam In Process": "bg-yellow-500/10 text-yellow-700 border-yellow-500/20",
  "Pre-Filed": "bg-yellow-500/10 text-yellow-700 border-yellow-500/20",
  "Application Processing": "bg-yellow-500/10 text-yellow-700 border-yellow-500/20",
  "Application Processed": "bg-yellow-500/10 text-yellow-700 border-yellow-500/20",
  "Assigned": "bg-yellow-500/10 text-yellow-700 border-yellow-500/20",
  "PAA Fee Due": "bg-yellow-500/10 text-yellow-700 border-yellow-500/20",
  "PAA Fee Pending": "bg-yellow-500/10 text-yellow-700 border-yellow-500/20",
  "PAA Fee Resolved": "bg-yellow-500/10 text-yellow-700 border-yellow-500/20",
  "Sign-Off": "bg-green-500/10 text-green-700 border-green-500/20",
...
export const MOCK_CO_APPLICATIONS: COApplication[] = [
  ...
  { num: 19, jobNum: "421464294", source: "DOB_JOB_FILINGS", fileDate: "2017-07-01", desc: "Installation of a prefabricated kiosk as per plans. No change in use, egress or occupancy.", tenant: null, floor: "1", docNum: null, jobType: "A2", workType: "OT", status: "Permit Issued", action: "EUP needed. Confirm if work is complete. Send out forms. Withdraw or request LOC.", assignedTo: null, priority: "Medium", bisOpenItems: [
    { id: "bis-19a", description: "Extension of Use Permit (EUP) — current permit expired", receivedFrom: "Borough Commissioner's Office", dateRequested: "2024-10-01", receivedDate: "", notes: "Must file for EUP before any further action. Contact expeditor.", resolved: false, signOffRequired: "DOB" },
    { id: "bis-19b", description: "TR1 — Special Inspection Sign-Off (Structural Steel)", receivedFrom: "Engineer — Thornton Tomasetti", dateRequested: "2024-12-15", receivedDate: "", notes: "Awaiting final letter from engineer. Site visit completed 01/15.", resolved: false, signOffRequired: "DOB" },
    { id: "bis-19c", description: "Fire Alarm Certificate of Fitness", receivedFrom: "FDNY — Bureau of Fire Prevention", dateRequested: "2024-12-20", receivedDate: "", notes: "C of F application submitted 12/20. Processing takes 4–6 weeks.", resolved: false, signOffRequired: "FDNY" },
    { id: "bis-19d", description: "Letter of Completion from Kiosk Operator", receivedFrom: "Kiosk Vendor — Mall Specialty Retail LLC", dateRequested: "2025-01-08", receivedDate: "", notes: "Form sent to vendor 01/08, awaiting signed copy.", resolved: false, signOffRequired: "Tenant" },
    { id: "bis-19e", description: "Updated As-Built Drawings (Kiosk Layout)", receivedFrom: "Architect — GF55 Partners", dateRequested: "2025-01-20", receivedDate: "", notes: "Architect revising layout to match field conditions. Expected by end of Feb.", resolved: false, signOffRequired: "DOB Plan Examiner" },
  ] },
