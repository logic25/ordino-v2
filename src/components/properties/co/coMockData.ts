...
export const MOCK_CO_APPLICATIONS: COApplication[] = [
  { num: 1, jobNum: "421644714", source: "DOB_JOB_FILINGS", fileDate: "2019-04-29", desc: "Additions to existing fire alarm system - Auntie Anne's Space #1033", tenant: "Auntie Anne's", floor: "1", docNum: "1", jobType: "A2", workType: "FA", status: "Signed Off", action: "Confirm sign-off recorded in BIS", assignedTo: null, priority: "Low" },
  ...
  { num: 3, jobNum: "421912728", source: "DOB_JOB_FILINGS", fileDate: "2019-10-22", desc: "Interior renovations - removal and installation of partitions, ceiling, door modifications. No change in use, egress or occupancy.", tenant: "Unknown", floor: "1", docNum: null, jobType: "A2", workType: "OT", status: "Approved", action: "Confirm if work is complete. Send out completion forms.", assignedTo: null, priority: "Medium" },
  ...
  { num: 9, jobNum: "421549202", source: "DOB_JOB_FILINGS", fileDate: "2018-03-01", desc: "Modification of existing sprinkler system on 1st floor at Superdry", tenant: "Superdry", floor: "1", docNum: null, jobType: "A2", workType: "SP", status: "Permit Issued", action: "Confirm if work is complete. Distribute LOC forms. Request LOC.", assignedTo: null, priority: "Medium" },
  ...
  { num: 17, jobNum: "440455017", source: "DOB_NOW_BUILD", fileDate: "2022-03-15", desc: "Install carport on 7th floor deck. No change in use, egress, or occupancy.", tenant: null, floor: "7", docNum: null, jobType: "A1", workType: "OT", status: "Plan Exam - Approved", action: "TR1/PW3 created. Await permit issuance.", assignedTo: null, priority: "Medium" },
...
export const MOCK_CO_VIOLATIONS: COViolation[] = [
  ...
  { violationNum: "V 012618ACC106208", type: "DOB VIOLATION - ACTIVE", fileDate: "2018-01-26", status: "Active", resolutionPlan: "", assignedTo: null, priority: "Medium", penalty: null },
...
export const MOCK_SIGN_OFFS: COSignOff[] = [
  { name: "Final Construction", status: "Pending", date: null, jobNum: null },
  { name: "Final Plumbing", status: "Signed Off", date: "01/20/2005", jobNum: "401536806" },
  { name: "Final Elevator", status: "Pending", date: null, jobNum: null },
  { name: "Temp Elevator", status: "Signed Off", date: "09/18/2019", jobNum: null },
  { name: "Final Electrical", status: "Pending", date: null, jobNum: null },
  { name: "Sprinkler (Garage)", status: "Signed Off", date: "05/17/2005", jobNum: "401536806" },
  { name: "Sprinkler (Mall)", status: "Signed Off", date: "05/17/2005", jobNum: "401536806" },
  { name: "Standpipe (Garage)", status: "Signed Off", date: "02/05/2004", jobNum: "401536726" },
  { name: "Standpipe (Mall)", status: "Signed Off", date: "03/18/2004", jobNum: "401623221" },
  { name: "Fire Alarm (Garage)", status: "Signed Off", date: "05/02/2007", jobNum: "401536735" },
  { name: "Fire Alarm (Mall)", status: "Signed Off", date: "05/02/2007", jobNum: "401538476" },
  { name: "Smoke Purge (Garage)", status: "Permit Issued", date: null, jobNum: "401414830" },
  { name: "Smoke Purge (Mall)", status: "Permit Issued", date: null, jobNum: "401414830" },
  { name: "Fire Protection Plan", status: "Approved", date: "02/10/2004", jobNum: "401808923" },
];
