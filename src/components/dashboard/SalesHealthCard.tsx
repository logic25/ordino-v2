...
import { useSalesHealth } from "@/hooks/useDashboardData";
        ...
        <div>
          <CardTitle className="text-base flex items-center gap-1.5">
            ...
            <InfoTooltip>
              ...
              executed ÷ sent) and average days from sent → client signed.
            </InfoTooltip>
          </CardTitle>
          <CardDescription>Pipeline + conversion trend</CardDescription>
        </div>
