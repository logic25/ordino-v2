...
export const DEFAULT_PIS_SECTIONS: RfiSectionConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "applicant_last_name", label: "Last Name", type: "text", required: true, width: "half" },
      ...
      { id: "applicant_business_state", label: "State", type: "text", width: "quarter" },
      { id: "applicant_business_zip", label: "Zip", type: "text", width: "quarter" },
      ...
      { id: "owner_first_name", label: "First Name", type: "text", required: true, width: "half" },
      ...
      { id: "owner_state", label: "State", type: "text", width: "quarter" },
      { id: "owner_zip", label: "Zip", type: "text", width: "quarter" },
  ...
  },
  {
    ...
    description: "Let us know if these parties have been selected",
    fields: [
      { id: "gc_heading", label: "General Contractor", type: "heading" },
      { id: "gc_known", label: "Do you know who the General Contractor is?", type: "select", options: ["Yes", "No"], width: "full" },
      ...
      { id: "sia_known", label: "Do you know who the Special Inspector is?", type: "select", options: ["Yes", "No"], width: "full" },
    ...
    queryFn: async () => {
      ...
      return {
        ...
        project: {
          ...
          unit_number: projects?.unit_number || prop.unit_number || null,
